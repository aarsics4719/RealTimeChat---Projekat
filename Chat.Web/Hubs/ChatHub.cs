...
namespace Chat.Web.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        public int SendPrivate(string message, string fromUserId, string toUserId)
        {
            ...
            {
                Clients.Caller.onError("Poruka nije poslata!");
            }
            return 0;
        }
        ...
        public void Join(int roomId)
        {
            ...
            {
                Clients.Caller.onError("Niste uspeli da se povežete na sobu!" + ex.Message);
            }
        }
        ...
        public int CreateRoom(string roomName, string userSelected)
        {
            ...
            {
                Clients.Caller.onError("Pravljenje sobe nije uspelo: " + ex.Message);
            }
            return 0;
        }
        ...
        public void EditRoom(int roomId, string userEditSelected)
        {
            ...
            {
                Clients.Caller.onError("Izmenjivanje sobe nije uspelo: " + ex.Message);
            }
        }
        ...
        public void StickMess(int Id)
        {
            ...
            {
                Clients.Caller.onError("Nemoguće je pinovati poruku: " + ex.Message);
            }
        }
        ...
        public void DeleteUserToRoom(string userId, int roomId)
        {
            ...
            {
                Clients.Caller.onError("Brisanje nije moguće: " + ex.Message);
            }
        }
